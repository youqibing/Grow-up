package com.example.floatingaction.Floating_Image;
...
public class ButtonFloat extends Button {
    ...
    public ButtonFloat(Context context, AttributeSet attrs) {
        super(context, attrs);
        //setBackgroundResource(R.drawable.background_button_float);//蓝色的圈
        setBackgroundColor(backgroundColor);//设置背景为蓝色
        sizeRadius = 28;
