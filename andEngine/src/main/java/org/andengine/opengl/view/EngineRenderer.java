...
public class EngineRenderer implements GLSurfaceView.Renderer {
	...
	@Override
	public void onSurfaceCreated(final GL10 pGL, final EGLConfig pEGLConfig) {	//仅调用一次，用于设置view的OpenGL ES环境,进行初始化内存和处理效率。
...
//			GLES20.glCullFace(GLES20.GL_BACK);
	...
	@Override
	public void onSurfaceChanged(final GL10 pGL, final int pWidth, final int pHeight) {		//当view的几何形状发生变化时调用，比如设备从竖屏变为横屏。
	...
	@Override
	public void onDrawFrame(final GL10 pGL) {	//每次重绘view时调用
		synchronized(GLState.class) {
